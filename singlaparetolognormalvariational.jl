## singlaparetolognormalvariational.jl
...
StatsPlots.savefig(my_plot, "Outputs/stan_posterior_densities_and_traces_variational.html");

#Save Chains for later use
using HDF5
using MCMCChainsStorage

h5open("Chains/stanparetolognormalchain_variational.h5", "w") do f
  write(f, samples)
end
...
savefig(cornerplot,"Outputs/paretolognormalpairsplot_variational.html")
...
#savefig(localbarrierplot,"paretolognormallocalbarrierplot_variational.html")
